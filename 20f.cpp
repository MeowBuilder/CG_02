...
std::vector<float> viewport_size = {
	0,0,WIN_W / 2 ,WIN_H / 2,
	(WIN_W / 2) + 10 ,(WIN_H / 2) + 10, (WIN_W / 2) - 20 ,(WIN_W / 2) - 20,
	(WIN_W / 2) + 10 ,0, (WIN_W / 2) - 20, (WIN_H / 2) - 20
};
...
void Viewport2() {
	...
	glm::mat4 view = glm::mat4(1.0f);
	view = glm::lookAt(glm::vec3(0, 5, 1), glm::vec3(0,0,0), cameraUp);
	unsigned viewLocation = glGetUniformLocation(shaderProgramID, "viewTransform");
	glUniformMatrix4fv(viewLocation, 1, GL_FALSE, &view[0][0]);
...
void Viewport3() {
	...
	glm::mat4 view = glm::mat4(1.0f);
	view = glm::lookAt(glm::vec3( 0,0,5 ), rotatedTarget, cameraUp);
	unsigned viewLocation = glGetUniformLocation(shaderProgramID, "viewTransform");
	glUniformMatrix4fv(viewLocation, 1, GL_FALSE, &view[0][0]);
